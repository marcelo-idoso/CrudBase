 ...
 */
class Controlador extends \Application\Entity\Controlador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Controlador' . "\0" . 'dsControlador', '' . "\0" . 'Application\\Entity\\Controlador' . "\0" . 'idmodule', 'id', 'date_create', 'date_update'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Controlador $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getDsControlador()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDsControlador', []);

        return parent::getDsControlador();
    }
     ...
     * {@inheritDoc}
     */
    public function setDsControlador($dsControlador)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDsControlador', [$dsControlador]);

        return parent::setDsControlador($dsControlador);
    }

    /**
     * {@inheritDoc}
     */
    public function setIdmodule(\Application\Entity\Module $idmodule)
    {
